...
public class AdminRest {
	...
	public void createCompany(@RequestBody CompanyService c, HttpServletRequest request)
	...
	@RequestMapping(value = "readcompany/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)

	public CompanyService readCompany(@PathVariable("id") long id, HttpServletRequest request)
	...
	public void createCustomer(@RequestBody CustomerService c, HttpServletRequest request)
			throws CouponSystemException, UniqueNameException {
		AdminFacade adminFacade = getAdminFacade(request);
		if (adminFacade != null) {
	...
	public void removeCustomer(@RequestBody CustomerService c, HttpServletRequest request)
			throws CouponSystemException {
		AdminFacade adminFacade = getAdminFacade(request);
		if (adminFacade != null) {
			Customer customer = c.convertToCustomer();
	...
	public void updateCustomer(@RequestBody CustomerService c, HttpServletRequest request)
			throws CouponSystemException {
		AdminFacade adminFacade = getAdminFacade(request);
		if (adminFacade != null) {
			Customer customer = c.convertToCustomer();
	...
	@RequestMapping(value = "readcustomer/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public CustomerService readCustomer(@PathVariable("id") long id, HttpServletRequest request)
			throws CouponSystemException {
		AdminFacade adminFacade = getAdminFacade(request);
		if (adminFacade != null) {
	...
	@RequestMapping(value = "readallcustomer", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
