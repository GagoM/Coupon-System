...
@RequestMapping("/company")
	public class CompanyRest {
		public CompanyFacade getCompanyFacade(HttpServletRequest request,HttpSession session){
		...
		public CompanyService getCompanyName(HttpServletRequest request,HttpSession session) throws CouponSystemException {

			CompanyFacade facade = getCompanyFacade(request,session);
			if (facade != null) {
				Company company = new Company();
				String compName = (String) request.getSession().getServletContext().getAttribute("username");
		...
		consumes = MediaType.APPLICATION_JSON_VALUE)
			public void createCoupon(@RequestBody CouponService c,HttpServletRequest request,HttpSession session) throws CouponSystemException, UniqueNameException {
		CompanyFacade companyFacade = getCompanyFacade(request,session);
		...
		consumes = MediaType.APPLICATION_JSON_VALUE)
		public void removeCoupon(@RequestBody CouponService c,HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
				Coupon coupon = c.convertToCoupon();
		...
		consumes = MediaType.APPLICATION_JSON_VALUE)
		public void updateCoupon(@RequestBody CouponService c,HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
				Coupon coupon = c.convertToCoupon();
		...
		@RequestMapping(value="readcoupon/{id}", method=RequestMethod.GET,
		produces = MediaType.APPLICATION_JSON_VALUE)
		
		public CouponService readCoupon(@PathVariable("id")long id,HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
		...
		produces = MediaType.APPLICATION_JSON_VALUE)
		public Collection<CouponService> getAllCoupon(HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
		...
		produces = MediaType.APPLICATION_JSON_VALUE)
		public Collection<CouponService> getCouponsByType(@PathVariable("type")CouponType c,HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
		...
		produces = MediaType.APPLICATION_JSON_VALUE)
		public Collection<CouponService> getCouponsByPrice(@PathVariable("price")double price,HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
				CouponService couponService = new CouponService();
				Collection<Coupon>list = new ArrayList<>();
		...
		produces = MediaType.APPLICATION_JSON_VALUE)
		public Collection<CouponService> getCouponsByDate(@PathVariable("date") String date,HttpServletRequest request,HttpSession session) throws CouponSystemException, ParseException {
		...
		@RequestMapping(value="getallexistingcoupons", method=RequestMethod.GET,
				produces = MediaType.APPLICATION_JSON_VALUE)
		public Collection<CouponService> getAllExistingCoupons(HttpServletRequest request,HttpSession session) throws CouponSystemException {
			CompanyFacade companyFacade = getCompanyFacade(request,session);
			if(companyFacade!=null){
