...
public class CustomerRest {
	...
	@RequestMapping(value = "getcustomerusername", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	public Collection<CouponService> getAllPurchasedCouponsByType(@PathVariable("type") CouponType type,
	...
	public Collection<CouponService> getAllPurchasedCouponsByPrice(@PathVariable("price") double price,
			HttpServletRequest request) throws CouponSystemException {
		CustomerFacade customerFacade = getCustomerFacade(request);
		if (customerFacade != null) {
	...
	@RequestMapping(value = "getallcouponforcustomer", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public Collection<CouponService> getAllCouponForCustomer(HttpServletRequest request)
	...
	@RequestMapping(value = "/getallcouponsbytypeforcustomer/{type}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public Collection<CouponService> getAllCouponsByType(@PathVariable("type") CouponType type,
			HttpServletRequest request) throws CouponSystemException, SQLException {
	...
	@RequestMapping(value = "/getallcouponsbypriceforcustomer/{price}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public Collection<CouponService> getAllCouponsByPrice(@PathVariable("price") double price,
			HttpServletRequest request) throws CouponSystemException, SQLException {
		CustomerFacade customerFacade = getCustomerFacade(request);
		if (customerFacade != null) {
